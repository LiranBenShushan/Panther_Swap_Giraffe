...
public class AddQuestion extends JFrame {
	...
	public AddQuestion() {
		...
		JLabel lblNewLabel_2 = new JLabel("Add New Question");
	...
	private void addQuestionActionPerformed(ActionEvent arg0) {
		boolean flag = false;
		String Text = "";
		String ans1 = "";
		String ans2 = "";
		...
		if (flag) {
			...
			Question q = new Question(Text, answers, CorrectAnswer, difficultly, "Giraffe");
			if (SysData.addQuestion(q)) {
